...
### Fixed
- Spielsuche: Lokalisierte Spielnamen (z. B. „Dune: Geheimnisse der Häuser") erscheinen jetzt in den Ergebnissen. Ursache: lokale DB-Suche hat bei ≥5 Treffern externe Quellen komplett übersprungen. Jetzt laufen lokale DB und alle externen Quellen (Wikidata, BGG) parallel; lokale Treffer erscheinen zuerst, externe füllen die restlichen Slots bis 15. Wikidata-Query erweitert auf EN + DE Labels; Scrape-Limit von 15 → 25 erhöht.
